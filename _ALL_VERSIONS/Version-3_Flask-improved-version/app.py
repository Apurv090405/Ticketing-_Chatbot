...
def initialize_session():
    if "state" not in session:
        session["state"] = {
            ...
            "step": "username",
            "output_history": [],
            "add_new_laptop": False  # Track checkbox state
        }
        ...
        if state["step"] == "username":
            ...
            if "add_laptop" in request.form:
                ...
                if all([new_laptop_name, new_laptop_model, new_cpu, new_ram, new_storage]):
                    ...
                    customer["laptops"].append(new_laptop)  # Fixed: Removed unnecessary nesting
                    if db.customers_collection.update_one(
                        ...
                        state["add_new_laptop"] = False  # Reset checkbox after adding
                    else:
